...
/* payload:
	...
	socket.on('invite',function(payload){
		...
		/* check if payload was sent */
			if(('undefined' === typeof payload) || !payload){
				var error_message = 'invite has no payload, command aborted';								log(error_message);
				log(error_message);
        ...
        log('invite successful');
			...
			/* payload:
				...
				socket.on('uninvite',function(payload){
					...
					/* check if payload was sent */
						if(('undefined' === typeof payload) || !payload){
							var error_message = 'uninvite has no payload, command aborted';								log(error_message);
							log(error_message);
			        ...
			        log('uninvite successful');
						...
						/* payload:
							...
							socket.on('game_start',function(payload){
								...
								/* check if payload was sent */
									if(('undefined' === typeof payload) || !payload){
										var error_message = 'game_start has no payload, command aborted';								log(error_message);
										log(error_message);
